...
from ultralytics.nn.modules import (
    AIFI, C1, C2, C3, C3TR, OBB, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C2fAttn, ImagePoolingAttn,
    ...
    RTDETRDecoder, Segment, WorldDetect, RepNCSPELAN4, ADown, SPPELAN, CBFuse, CBLinear, Silence,
    C2fCIB, PSA, SCDown, RepVGGDW, v10Detect, G_bneck, PatchMerging, PatchEmbed, SwinStage,
    VanillaBlock, SGBlock,ConvNeXt_Stem, ConvNeXt_Block, ConvNeXt_Downsample,
    MobileNetV3_BLOCK, InvertedBottleneck, mn_conv, StarBlock,DepthSepConv,CBRM, Shuffle_Block,
    stem, MBConvBlock,Conv_BN_HSwish, MobileNetV3_InvertedResidual,BasicStage, PatchEmbed_FasterNet,
    PatchMerging_FasterNet, SimAM, ECA, SpatialGroupEnhance, TripletAttention, CoordAtt, GAMAttention,
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB, VoVGSCSPC, C2f_SPCA
):
        ...
        # ------------Attention ↑--------------
            ...
            c1 = ch[f]
            args = [c1, *args[0:]]
        elif m in [FGFP, FGFP_Head]:
            c1 = ch[f]
            args = [c1, *args[0:]]  # 保持原始参数结构
        elif m is SPCA:
            c1 = ch[f]
            args = [c1]
            c2 = c1  # 输出通道数等于输入通道
